    ...
    <div class="table-sanpham">
      <div class="container">
        ...
        <form action="<?php echo base_url() ?>admin/product/locSanPham" method="get">
          ...
          Tên: <input type="text" name="name" value="<?php echo $this->input->get('name') ?>" style="margin-right: 50px;">
       ...
       <!-- </form> -->
        <div class="nutxoahet">
          <a href="" class="btn btn-outline-danger xoahet" id="" style="cursor: pointer;">Xoá hết <i class="fa fa-times" aria-hidden="true"></i></a>
        </div>
     </div> <!--end container-->

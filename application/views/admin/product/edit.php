		...
		<div class="row">
			<div class="col-sm-10 push-sm-1">
				<div class="jumbotron ml-3" style="width: 100%;">
					...
					<form action="<?php echo base_url() ?>admin/product/edit/<?= $value['id'] ?>" method="POST" enctype="multipart/form-data">
						...
						<div class="tab-content" id="myTabContent">
							...
							<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
								...
								<input type="text" class="form-control dodai" id="name" value="<?= $value['name'] ?>" name="name" placeholder="Nhập tên sản phẩm...">
								<div class="clear error" name="name_error"><?php //echo form_error('name') ?> </div>

								<label for="" style="color: black;margin-top: 10px;">Thuộc danh mục:</label>
								<input type="number" class="form-control number" id="catalog_id" value="<?= $value['catalog_id'] ?>" name="catalog_id"">
								...
								<input type="number" class="form-control number" id="price" value="<?= $value['price'] ?>" name="price"">
								...
								<input type="number" class="form-control number" id="discount" value="<?= $value['discount'] ?>" name="discount"">
							...
							<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
								...
								<input type="text" class="form-control" name="image_link_old" id="image_link_old" value="<?= $value['image_link'] ?>">
								<input type="file" class="form-control" name="image_link" id="image_link" value="<?= $value['image_link'] ?>">

								<label for="" style="color: black;margin-top: 10px;">Ảnh liên quan:</label>
								<input type="text" class="form-control" name="image_list_old" id="image_list_old" value="<?= $value['image_list'] ?>">
								<input type="file" class="form-control" name="image_list" id="image_list" value="<?= $value['image_list'] ?>">
							...
							<div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
								...
								<input type="number" class="form-control number" id="count_buy" value="<?= $value['count_buy'] ?>" name="count_buy"">
								...
								<input type="number" class="form-control number" id="view" value="<?= $value['view'] ?>" name="view"">
								<div class="clear error" name="name_error"><?php //echo form_error('view') ?> </div>
							
							</div>	
							
						</div>
						<button type="submit" class="btn btn-primary nutthem">Cập nhật</button>
					</form>
					<?php endforeach ?>
				</div>
			</div>	

 ...
 ?>
	...
	<div class="banner-shop" style="background: url(<?php echo base_url() ?>public/site/images/08.jpg) no-repeat center center;">
		<div class="container">
			<div class="noidung">
				<h1>Sản phẩm</h1>
				<span><a href="<?php echo base_url() ?>home/index" class="tc">Trang chủ</a></span>&nbsp;/&nbsp;<span>Sản phẩm</span>
			</div>
		</div>
	...
	<div class="noidung-shop">
		<div class="container">
			<div class="noidung-top-shop">
				...
				<span><!-- Sản phẩm hiển thị cho: <?php //echo  $search ?> --></span>
